...
class PPOTrainer(BaseRLTrainer):
    ...
    def _compute_actions_and_step_envs(self, buffer_index: int = 0):
        ...
        with inference_mode():
            ...
            # print("======= step_batch[observations] =======", step_batch["observations"])
    ...
    def train(self) -> None:
        ...
        if os.path.exists(self.config.habitat_baselines.pretrained_weight_path):

            self._agent.load_ckpt_state_dict(torch.load(self.config.habitat_baselines.pretrained_weight_path))
    ...
    def _eval_checkpoint(
        ...
        while (
            ...
            # in the subprocesses.
            # print("Actions are: ", action_data.actions)
            # print("Values are: ", action_data.values)
            if is_continuous_action_space(self._env_spec.action_space):
                # Clipping actions to the specified limits
                step_data = [
                    np.clip(
