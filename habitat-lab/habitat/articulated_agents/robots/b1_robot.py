...
class B1Robot(MobileManipulator):
    def _get_b1_params(self):
        return B1Params(
            arm_joints=[13,14,15,16,17,18],
            gripper_joints=[20],
            leg_joints=list(range(0,12)),
            arm_init_params=[0.0, 0.45, -0.7, 0.3, 0.0, 0.0],
            ...
            cameras={
                "articulated_agent_arm_depth": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(0.049, 0.0, 0.05),
