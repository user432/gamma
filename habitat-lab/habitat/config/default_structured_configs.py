...
__all__ = [
    ...
    "EETransformationSensorConfig",
    "ACTransformationSensorConfig",
    "GraspSensorConfig",
    "JointSensorConfig",
    ...
    # "GraspingInfoGainRewardMeasurementConfig",
    # "GraspingDistanceRewardMeasurementConfig",

    "GraspingDistanceRewardMeasurementConfig",
    "GraspingOrientationRewardMeasurementConfig",
    "GraspingNodesRewardMeasurementConfig",
    "GraspingEdgesRewardMeasurementConfig",
    "GraspingFusedCountRewardMeasurementConfig",
    "GraspingTotalScoreRewardMeasurementConfig",
...
@dataclass
class EETransformationSensorConfig(LabSensorConfig):
    r"""
    Rearrangement only. the cartesian coordinates (3 floats) of the arm's end effector in the frame of reference of the robot's base.
    """
    type: str = "EETransformationSensor"


@dataclass
class ACTransformationSensorConfig(LabSensorConfig):
    r"""
    Rearrangement only. the cartesian coordinates (3 floats) of the arm's end effector in the frame of reference of the robot's base.
    """
    type: str = "ACTransformationSensor"

@dataclass
class GraspSensorConfig(LabSensorConfig):
    r"""
    Rearrangement only. the cartesian coordinates (3 floats) of the arm's end effector in the frame of reference of the robot's base.
    """
    type: str = "GraspSensor"
...
@dataclass
class EndEffectorToTargetEndEffectorDistanceMeasurementConfig(MeasurementConfig):
    type: str = "EndEffectorToTargetEndEffectorDistance"
...
# @dataclass
# class GraspingInfoGainRewardMeasurementConfig(MeasurementConfig):
#     type: str = "GraspingInfoGainReward"


# @dataclass
# class GraspingDistanceRewardMeasurementConfig(MeasurementConfig):
#     type: str = "GraspingDistanceReward"


@dataclass
class GraspingOrientationRewardMeasurementConfig(MeasurementConfig):
    type: str = "GraspingOrientationReward"
...
@dataclass
class GraspingNodesRewardMeasurementConfig(MeasurementConfig):
    type: str = "GraspingNodesReward"

@dataclass
class GraspingEdgesRewardMeasurementConfig(MeasurementConfig):
    type: str = "GraspingEdgesReward"

@dataclass
class GraspingFusedCountRewardMeasurementConfig(MeasurementConfig):
    type: str = "GraspingFusedCountReward"

@dataclass
class GraspingTotalScoreRewardMeasurementConfig(MeasurementConfig):
    type: str = "GraspingTotalScoreCountReward"
...
cs.store(
    package="habitat.task.lab_sensors.end_effector_sensor_transformation",
    group="habitat/task/lab_sensors",
    name="end_effector_sensor_transformation",
    node=EETransformationSensorConfig,
)
cs.store(
    package="habitat.task.lab_sensors.arm_camera_sensor_transformation",
    group="habitat/task/lab_sensors",
    name="arm_camera_sensor_transformation",
    node=ACTransformationSensorConfig,
)

cs.store(
    package="habitat.task.lab_sensors.grasp_sensor",
    group="habitat/task/lab_sensors",
    name="grasp_sensor",
    node=GraspSensorConfig,
)
...
cs.store(
    package="habitat.task.measurements.end effector_to_target_ee_distance",
    group="habitat/task/measurements",
    name="end_effector_to_target_ee_distance",
    node=EndEffectorToTargetEndEffectorDistanceMeasurementConfig,
)
cs.store(
...
# cs.store(
#     package="habitat.task.measurements.grasp_distance_reward",
#     group="habitat/task/measurements",
#     name="grasp_distance_reward",
#     node=GraspingDistanceRewardMeasurementConfig,
# )

# cs.store(
#     package="habitat.task.measurements.grasp_infogain_reward",
#     group="habitat/task/measurements",
#     name="grasp_infogain_reward",
#     node=GraspingInfoGainRewardMeasurementConfig,
# )

cs.store(
    package="habitat.task.measurements.grasp_distance_reward",
    group="habitat/task/measurements",
    name="grasp_distance_measure",
    node=GraspingDistanceRewardMeasurementConfig,
)

cs.store(
    package="habitat.task.measurements.grasp_ori_measure",
    group="habitat/task/measurements",
    name="grasp_ori_measure",
    node=GraspingOrientationRewardMeasurementConfig,
)

cs.store(
    package="habitat.task.measurements.grasp_nodes_measure",
    group="habitat/task/measurements",
    name="grasp_nodes_measure",
    node=GraspingNodesRewardMeasurementConfig,
)

cs.store(
    package="habitat.task.measurements.grasp_edges_measure",
    group="habitat/task/measurements",
    name="grasp_edges_measure",
    node=GraspingEdgesRewardMeasurementConfig,
)

cs.store(
    package="habitat.task.measurements.grasp_fused_count_measure",
    group="habitat/task/measurements",
    name="grasp_fused_count_measure",
    node=GraspingFusedCountRewardMeasurementConfig,
)

cs.store(
    package="habitat.task.measurements.grasp_total_score_measure",
    group="habitat/task/measurements",
    name="grasp_total_score_measure",
    node=GraspingTotalScoreRewardMeasurementConfig,
)
