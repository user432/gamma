...
from habitat.articulated_agents.robots.b1_robot import B1Robot
...
class GazeGraspAction(MagicGraspAction):
    ...
    def get_camera_transform(self):
        ...
        elif isinstance(self.cur_articulated_agent, B1Robot):
            cam_info = self.cur_articulated_agent.params.cameras[
                "articulated_agent_arm_depth"
            ]
        elif isinstance(self.cur_articulated_agent, FetchRobot):
            cam_info = self.cur_articulated_agent.params.cameras[
                "articulated_agent_arm_depth"
            ]
    ...
    def determine_center_object(self):
        ...
        if isinstance(self.cur_articulated_agent, SpotRobot):
            ...
            cam_pos = (
                self._sim.agents[0]
                .get_state()
                .sensor_states["articulated_agent_arm_depth"]
                .position
            )
        elif isinstance(self.cur_articulated_agent, StretchRobot):
            cam_pos = (
